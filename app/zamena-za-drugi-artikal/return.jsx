                    ...
                    >
                        ...
                        <div className={`col-span-1 flex flex-col items-start`}>
                            ...
                            <input
                                type={`text`}
                                disabled={false}
                                value={formData.sku_old}
                                name={`sku_old`}
                                onChange={handleChange}
                                className={`mt-1 w-full ${
                                    errors.includes("sku_old")
                                        ? "border border-red-500  focus:border-red-500 focus:ring-0 focus:outline-0"
                                        : "border border-[#e0e0e0] focus:border-[#e0e0e0] focus:ring-0 focus:outline-0"
                                }`}
                            />
                        ...
                        <div className={`col-span-1 flex flex-col items-start`}>
                            <label className={`text-base font-light`}>
                                Boja artikla koji se vraća{" "}
                                <span className={`snap-mandatory text-red-500`}>*</span>
                            </label>
                            <input
                                type={`text`}
                                disabled={false}
                                value={formData.color_old}
                                name={`color_old`}
                                onChange={handleChange}
                                className={`mt-1 w-full ${
                                    errors.includes("color_old")
                                        ? "border border-red-500  focus:border-red-500 focus:ring-0 focus:outline-0"
                                        : "border border-[#e0e0e0] focus:border-[#e0e0e0] focus:ring-0 focus:outline-0"
                                }`}
                            />
                        ...
                        <div className={`col-span-1 flex flex-col items-start`}>
                            ...
                            <input
                                type={`text`}
                                disabled={false}
                                value={formData.color_new}
                                name={`color_new`}
                                onChange={handleChange}
                                className={`mt-1 w-full ${
                                    errors.includes("color_new")
                                        ? "border border-red-500  focus:border-red-500 focus:ring-0 focus:outline-0"
                                        : "border border-[#e0e0e0] focus:border-[#e0e0e0] focus:ring-0 focus:outline-0"
                                }`}
                            />
